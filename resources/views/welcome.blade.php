...
<head>
    ...
    <title>Pies Business Invoice</title>
...
<div class="d-flex h-100 p-3 mx-auto flex-column" style="background-color: black; opacity: 70%;" >
    <header class="masthead mb-auto" >
        <div class="inner" >
            <h3 class="masthead-brand">Pies Business Invoice</h3>
    ...
    <main role="main" class="inner cover">
        <h1 class="cover-heading">Pies Business Invoice</h1>
